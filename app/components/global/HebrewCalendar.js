...
function HebrewCalendar(props) {
  ...
  function Style(i, isOtherMonth) {
    ...
    if (
      ...
      return " text-[rgba(77,77,77,0.44)]";
    } else {
      return " hover:bg-medium-blue hover:text-white";
    }
  }
 ...
 hover:text-white ${Style(i, true)}`}
  ...
  return (
    <>
      <div ref={calendarRef} className="flex flex-col items-center">
        <div className="flex items-center text-lg gap-1.5 text-medium-blue font-medium mt-2">
